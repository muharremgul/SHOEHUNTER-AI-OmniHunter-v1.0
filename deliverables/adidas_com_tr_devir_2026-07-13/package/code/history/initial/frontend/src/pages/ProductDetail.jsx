              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    <span className={f.in_stock ? "badge-stock" : "badge-nostock"}>{f.in_stock ? "Stokta" : "Stok yok"}</span>
                  </div>
                </div>
              </button>
            ))}
              ...
              <tbody>
                {listings.map((l) => (
                  <tr key={l.id} className="border-b border-zinc-800 hover:bg-zinc-900/50 last:border-0" data-testid={`listing-row-${l.id}`}>
                    ...
                    <td className="py-3 pr-4">
                      <span className={l.last_in_stock ? "badge-stock" : "badge-nostock"}>
                        {l.last_sizes?.length ? `${l.last_stock_count}/${l.last_sizes.length} beden` : l.last_in_stock ? "Stokta" : "Belirsiz"}
                      </span>
                    </td>
