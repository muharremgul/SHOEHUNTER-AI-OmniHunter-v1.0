...
- Intersport (özel parser): pz-price, .product-price içinde min/max fiyat (güncel/eski), .product-item__offers sepet indirimi, JSON-LD fallback (+>15000/10 bug düzeltmesi), pz-variant key=integration_beden beden/stok (selectable attr), SKU. Arama: /list/?search_text={q}, ürün pattern /urun/
