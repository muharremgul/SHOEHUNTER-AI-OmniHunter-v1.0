...
import { Sneaker, LinkSimple, Target, BellRinging, Clock, CheckCircle, XCircle, Fire } from "@phosphor-icons/react";
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-zinc-500">
                      {a.store} · Beden: {a.size} · {fmtDate(a.created_at)}
                    </div>
                  </div>
                  <div className="text-right shrink-0 ml-4">
                    <div className="text-primary font-mono font-bold">{fmtPrice(a.price)}</div>
                    <div className="text-xs text-zinc-500">Hedef: {fmtPrice(a.target_price)}</div>
                  </div>
                </div>
              ))}
            </div>
